...
async def command_start(message: Message):
    await message.answer('Здравствуйте, здесь вы найдете обои на любой вкус!')
...
async def get_image(message: Message):
    ...
    # 2 запроса или 1 запрос с подзапросом?
...
Лучшие обои здесь: @You_favorite_wallpapersBot'''
    ...
    try:
        ...
        try:
            ...
            await message.answer('Что-то пошло нет так. Попробуйте снова')


# Функция для реакции на нажатие кнопки
...
# библиотека Pillow
# скачать картинку - на картинку поставить водяной знак с текстом - название вашего бота
